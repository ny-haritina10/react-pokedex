...
export default function Hero() {
  ...
  const handleGetStarted = () => {
    navigate('/pokedex');       // redirects to the Pokedex component
  };
  ...
  return (
    <section className="bg-white text-center py-16">
      ...
      <button
        ...
        className="mt-8 bg-red-500 text-white px-6 py-3 rounded-full hover:bg-yellow-500 transition duration-300"
      >
        Get Started
      </button>
      <div className="mt-10">
